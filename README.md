...
本文由 GPT 写作，有问题可以反馈 b站 UP：杂粮煎饼大王。  
或者提交 issues
...
2025G 文件目录下，有一些文本文件和图片，和一个 ipynb 是 Up 在用于调试和整理思路的一些 python 文件，这些 Git 的时候一并上传上来，并无用处，主要参考 MDK-ARM 文件里面的 2025G 的 Keil 工程，一切以最后的代码工程为准。
